...
public class DurationTest {
    ...
    */
    ...
    public void testDuration(){
        ...
        Duration duration1 = new APDuration(1,0);
    ...
    public void testDuration2(){
        ...
        Duration duration2 = new APDuration(0,10);
    ...
    public void testDuration3(){
        ...
        Duration duration3 = new APDuration(1,30);
    ...
    */
    ...
    public void testLargeMinuteCount(){
        ...
        Duration duration1 = new APDuration(0,90);
    ...
    */
    ...
    public void testLargeMinuteCountWithHours(){
        ...
        Duration duration1 = new APDuration(1,90);
    ...
    */
    ...
    public void testPlusDuration(){
      ...
      /*Duration duration2 = new Duration(0,90);
        ...
        Duration duration4 = new APDuration(1,30);
    ...
    public void testPlusDuration2(){
        ...
        Duration duration2 = new APDuration(0,90);
        Duration duration3 = new APDuration(1,90);
    ...
    public void testPlusDuration3(){
        ...
        Duration duration1 = new APDuration(1,0);
        Duration duration5 = new APDuration(0,120);
